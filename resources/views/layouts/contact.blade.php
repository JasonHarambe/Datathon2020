    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-9">
            <div class="row d-flex justify-content-between">
                ...
                <div class="card shadow" style="width: 18rem;">
                    <img class="card-img-top" src="/img/ahmad.jpg" alt="Card image cap" style="height: 20vw; width: 100%; object-fit:cover;">
                    <div class="card-body">
                        <h5 class="card-title">Wan Ahmad Luqman</h5>
                        <p class="card-text">MSc Data Science student from Universiti Teknologi Malaysia</p>
                        <a href="https://www.linkedin.com/in/wan-luqman-4753aa180/" class="btn btn-primary shadow" target="_">LinkedIn</a>
                    </div>
                </div>
                <div class="card shadow" style="width: 18rem;">
