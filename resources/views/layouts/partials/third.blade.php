...
<div class="row d-flex justify-content-center py-4">
    <div class="col-md-6">
        <div class="row d-flex flex-column">
            <h1 class="text-center display-3">Third Category</h1>
            ...
            <div class="row d-flex justify-content-center">
                <a href="/{{$id}}/{{$first}}" class="text-uppercase text-dark font-weight-bold">BACK</a>
...
<div class="row d-flex justify-content-center">
    <div class="col-md-6 pb-5">
        ...
        @foreach ( $trades as $third)
            <a href="/{{$id}}/{{$first}}/{{$second}}/{{$third}}" class="list-group-item list-group-item-action">{{ $third }}</a>
        @endforeach
        </div>
    </div>
</div>
