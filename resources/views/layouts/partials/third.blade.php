            ...
            <ul class="nav flex-column pb-3 mb-5">
                <div class="row d-flex py-3 flex-column mx-3">
                    ...
                    <div class="row d-flex justify-content-center mt-2">
                        ...
                        <a href="/master/{{ $id }}/{{ $first }}" class="btn btn-success btn-sm text-uppercase" role='button'>back</a>
                    </div>
                </div>
            @foreach ($trades as $key => $value)
                <a href="/master/{{ $id }}/{{ $first }}/{{ $second }}/{{ $value->desc }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                    {{ $value->desc }}
