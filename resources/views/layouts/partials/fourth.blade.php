            ...
            <ul class="nav flex-column pb-3 mb-5">
                <div class="row d-flex py-3 flex-column mx-3">
                    ...
                    <div class="row d-flex justify-content-center mt-2">
                        ...
                        <a href="/{{ $id }}/{{ $first }}/{{ $second }}" class="btn btn-success btn-sm text-uppercase" role='button'>back</a>
                    </div>
                </div>
        ...
        <div class="row d-flex justify-content-center py-4">
            <div class="col-md-8 d-flex flex-column">
                ...
                <div class="row d-flex justify-content-center border-top">
                    <a class="btn btn-primary shadow text-center btn-sm mx-5 text-uppercase mt-2" href="/{{ $id }}/{{ $first }}/{{ $second }}" role="button">Back</a> 
                </div>  
            </div>
        </div>
