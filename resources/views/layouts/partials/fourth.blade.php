...
<div class="row d-flex justify-content-center py-4">
    <div class="col-md-6">
        <div class="row d-flex flex-column">
            <h1 class="text-center display-3">Fourth Category</h1>
            ...
            <div class="row d-flex justify-content-center">
                <a href="/{{$id}}/{{$first}}/{{$second}}" class="text-uppercase text-dark font-weight-bold">BACK</a>
...
<div class="row d-flex justify-content-center">
    <div class="col-md-6 pb-5">
        ...
        @foreach ( $trades as $fourth)
            <a href="/{{$id}}/{{$first}}/{{$second}}/{{$third}}/{{$fourth}}" class="list-group-item list-group-item-action">{{ $fourth }}</a>
        @endforeach
        </div>
    </div>
</div>
